...
\input{fig_tex/multiwave1}
\input{fig_tex/multiwave2}
\input{fig_tex/ior}
\input{fig_tex/particlesize}
...
\input{fig_tex/anisotropic1}
\input{fig_tex/anisotropic2}
