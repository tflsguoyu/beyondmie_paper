\begin{figure*}[t]
    ...
    \begin{tabular}{ccc|ccc|ccc}
        \multicolumn{3}{c|}{\includegraphics[height=\resLenTwo]{pfunc/distance.png}} &
        \multicolumn{3}{c|}{\includegraphics[height=\resLenTwo]{pfunc/radius.png}} &
        \multicolumn{3}{c}{\includegraphics[height=\resLenTwo]{pfunc/number.png}} \\[-5pt]
